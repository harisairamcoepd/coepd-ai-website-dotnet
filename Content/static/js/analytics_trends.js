(function () {
  ...
  logoImage.src = "/Content/static/images/logo2.png?v=20260317";
  ...
  async function loadCard(config) {
    ...
    try {
      ...
      // Render only after content becomes visible so Chart.js can measure canvas correctly.
      requestAnimationFrame(function () {
        ...
        if (charts[config.key]) charts[config.key].resize();
      });
    } catch (error) {
